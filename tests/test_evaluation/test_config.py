...
# `ad9e2afac12c`/`87fc0bb24c42`, and again to `96e265a90f59` for the shared excerpt budget, and `0b24ed022ed8` for the review fixes (the packet's own record of what it could not carry, the least-creditable duplicate row, and unclear stances that block without asserting)/`3a96c3e6293d`/`2c80a78040b9`). Real prompt
