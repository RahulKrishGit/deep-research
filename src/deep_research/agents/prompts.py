...
CRITIC_REVIEW_SYSTEM_PROMPT = (
    ...
    "planned, the verdicts already reached for individual claims, each source's "
    "quality score when scored or explicit evaluation status otherwise, and any "
    "problems recorded during the pass. Judge "
    "that material alone.\n"
    "Judge completeness against the research question, accuracy against the "
